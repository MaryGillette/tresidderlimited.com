...
Rails::Initializer.run do |config|
  ...
  PRIMARY_DOMAIN = 'examplke.com'
  SITE_NAME = "Rails Code Base"
...
ExceptionNotifier.exception_recipients = %w(info@dinshawdesign.com)
ExceptionNotifier.sender_address = %("#{SITE_NAME} App Error" <auto@example.com>)
