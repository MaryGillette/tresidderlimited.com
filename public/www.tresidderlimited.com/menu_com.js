...
function MbrSetUp(MmbrCntnr,PrMmbr,WhatMenu,Wdth,Hght){
	...
	if(eval(WhatMenu+'[3]')&&ShowArrow){
		...
		if(DomYes){
			...
			t.style.top=T+P_X;
			t.style.left=L+P_X}
		else{	MemVal+="<div style='position:absolute; top:"+T+"; left:"+L+"; width:"+W+"; height:"+H+";visibility:inherit'><img src='"+S+".html'></div>";
...
function NavMbrSetUp(MmbrCntnr,PrMmbr,WhatMenu,Wdth,Hght){
	...
	if(eval(WhatMenu+'[3]')&&ShowArrow){
		...
		ImgStr="<img src='"+Arrws[a]+".html' width='"+Arrws[a+1]+"' height='"+Arrws[a+2]+"'>";
